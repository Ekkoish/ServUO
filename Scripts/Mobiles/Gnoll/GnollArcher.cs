...
namespace Server.Mobiles
{
	...
	public class GnollArcher : BaseCreature, IMediumPredator, IRodent
	{
		[Constructable]
		public GnollArcher() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a gnoll archer";
			BodyValue = 102;
			BaseSoundID = 594;
		...
		public GnollArcher( Serial serial ) : base( serial )
		{
		}
