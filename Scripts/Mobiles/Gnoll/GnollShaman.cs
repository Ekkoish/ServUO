...
namespace Server.Mobiles
{
	...
	public class GnollShaman : BaseCreature, IMediumPredator, IRodent
	{
		[Constructable]
		public GnollShaman() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a gnoll spellweaver";
			BodyValue = 102;
			BaseSoundID = 594;
		...
		public GnollShaman( Serial serial ) : base( serial )
		{
		}
