...
{
	public class ArmingSword : BaseSword
	{
		public override string NameType{ get{ return "arming sword"; } }
		...
		[Constructable]
		public ArmingSword() : base( 0x3D06 )
		{
			Weight = 6.0;
			Name = "arming sword";
		...
		public ArmingSword( Serial serial ) : base( serial )
		{
		}
